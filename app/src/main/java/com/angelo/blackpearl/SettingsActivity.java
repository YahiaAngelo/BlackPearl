...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    public static class NotificationPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            SwitchPreference vibrate = (SwitchPreference) findPreference("notifications_new_message_vibrate");
            ...
            SwitchPreference messagesNotification = (SwitchPreference) findPreference("notifications_new_message");
            messagesNotification.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
                @Override
                public boolean onPreferenceChange(Preference preference, Object newValue) {
                    boolean isNotificationsOn = (boolean) newValue;
                        ...
                        FirebaseMessaging.getInstance().subscribeToTopic("newpost")
                                .addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    if (!task.isSuccessful()){
                                        ...
                                        Toast.makeText(MainActivity.context, "You Can Get New Updates Notification!", Toast.LENGTH_SHORT).show();
                                    }
                                });
